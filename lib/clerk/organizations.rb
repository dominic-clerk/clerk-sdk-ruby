...
module Clerk
  ...
  class Organizations
    ...
    def get_billing_credit_balance(organization_id:, retries: nil, timeout_ms: nil)
    ...
    def adjust_billing_credit_balance(body:, organization_id:, retries: nil, timeout_ms: nil)
