  ...
  module Models
    module Operations
      ...
      class UpdateEnterpriseConnectionRequestBody
        ...
        def initialize(name: nil, domains: nil, active: nil, sync_user_attributes: nil, disable_additional_identifications: nil, organization_id: nil, saml: nil, oidc: nil, custom_attributes: nil)
          @name = name
          @domains = domains
          @active = active
