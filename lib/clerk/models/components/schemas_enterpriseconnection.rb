  ...
  module Models
    module Components
      ...
      class SchemasEnterpriseConnection
        ...
        def initialize(id:, name:, active:, domains:, created_at:, updated_at:, sync_user_attributes: nil, disable_additional_identifications: nil, custom_attributes: nil, organization_id: nil, saml_connection: nil, oauth_config: nil)
          @id = id
          @name = name
          @active = active
          @domains = domains
